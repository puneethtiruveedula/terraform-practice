...
![alt text](terraform-practice/aws-vpc-module/images/vpc.jpeg)
...
* database_subnet_group_name: A database subnet group Name created.
* ig_id: internte gateway created.